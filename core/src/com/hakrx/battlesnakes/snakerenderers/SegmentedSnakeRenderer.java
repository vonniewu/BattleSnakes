...
public class SegmentedSnakeRenderer extends SnakeRenderer {
    @Override
    ...
    public void renderAt(Point<Integer> pixelCoordinate, int tileDimension, ShapeRenderer shapeRenderer) {
        shapeRenderer.rect(pixelCoordinate.getX() + 1, pixelCoordinate.getY() + 1, tileDimension - 1, tileDimension - 1);
    }
}
